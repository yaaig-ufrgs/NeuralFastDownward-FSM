...
class KFoldTrainingData:
    def __init__(
        ...
        clamping=DEFAULT_CLAMPING,
        remove_goals=DEFAULT_REMOVE_GOALS,
        standard_first=DEFAULT_STANDARD_FIRST,
        contrast_first=DEFAULT_STANDARD_FIRST,
        intercalate_samples=DEFAULT_INTERCALATE_SAMPLES,
        cut_non_intercalated_samples=DEFAULT_CUT_NON_INTERCALATED_SAMPLES,
        model=DEFAULT_MODEL,
    ):
