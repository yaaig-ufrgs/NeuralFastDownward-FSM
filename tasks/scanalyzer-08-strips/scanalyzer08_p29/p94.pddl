(define (problem scanalyzer3d-62)
  ...
  (:objects
    ...
    seg-out-3b - segment
		...
		(analyzed car-out-3a)
		(analyzed car-out-3b)
		(on car-in-1a seg-in-1b)
		(on car-in-1b seg-out-2b)
		(on car-in-2a seg-out-3a)
		(on car-in-2b seg-in-1a)
		(on car-in-3a seg-in-2a)
		(on car-in-3b seg-out-3b)
		(on car-out-1a seg-out-1b)
		(on car-out-1b seg-in-3b)
		(on car-out-2a seg-in-3a)
		(on car-out-2b seg-out-1a)
		(on car-out-3a seg-out-2a)
		(on car-out-3b seg-in-2b)
		(= (total-cost) 0)
