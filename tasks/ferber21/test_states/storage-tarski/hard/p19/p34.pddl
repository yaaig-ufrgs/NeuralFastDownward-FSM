...
(:init
	(at hoist0 container-2-0)
	(at hoist1 container-1-1)
	(at hoist2 loadarea)
	(available hoist0)
	(available hoist1)
	(available hoist2)
	...
	(on crate3 depot2-1-1)
	(on crate4 container-1-3)
	(on crate5 container-1-2)
	(on crate6 depot1-2-2)
	(on crate7 depot2-2-1)
	(on crate8 depot2-2-2)
