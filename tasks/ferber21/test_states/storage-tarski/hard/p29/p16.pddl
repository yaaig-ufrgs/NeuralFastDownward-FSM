...
(:init
	(at hoist0 depot1-2-4)
	(at hoist1 depot3-1-3)
	(at hoist2 depot3-2-1)
	(at hoist3 container-2-1)
	(at hoist4 depot1-2-1)
	(available hoist0)
	(available hoist1)
	(available hoist2)
	(available hoist3)
	...
	(in1 crate10 container4)
	(in1 crate11 container3)
	...
	(on crate10 container-4-1)
	(on crate11 container-3-2)
	(on crate12 container-3-0)
	(on crate13 container-3-1)
	(on crate14 depot0-1-1)
	(on crate15 depot4-3-2)
	(on crate16 container-4-0)
	(on crate17 depot0-2-1)
	(on crate18 depot1-2-2)
	(on crate2 container-4-2)
