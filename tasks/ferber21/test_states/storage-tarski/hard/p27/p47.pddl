...
(:init
	(at hoist0 container-2-3)
	(at hoist1 loadarea)
	(at hoist2 container-1-0)
	(at hoist3 loadarea)
	(at hoist4 depot0-1-1)
	(available hoist2)
	(available hoist4)
	(clear container-0-0)
	(clear container-0-2)
