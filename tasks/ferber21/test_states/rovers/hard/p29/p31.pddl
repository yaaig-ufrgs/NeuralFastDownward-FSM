...
(:init
	...
	(have_image rover8 objective1 colour)
	(have_image rover8 objective4 colour)
	(have_image rover8 objective4 low_res)
	(have_image rover8 objective5 high_res)
	(have_image rover8 objective5 low_res)
	(have_image rover8 objective7 colour)
	(have_image rover8 objective7 high_res)
	(have_image rover9 objective1 high_res)
	(have_image rover9 objective2 high_res)
	(have_image rover9 objective7 high_res)
	(have_rock_analysis rover4 waypoint28)
	(have_rock_analysis rover4 waypoint41)
	(have_rock_analysis rover5 waypoint38)
	(have_rock_analysis rover7 waypoint20)
	(have_rock_analysis rover7 waypoint27)
	(have_soil_analysis rover0 waypoint13)
	(have_soil_analysis rover1 waypoint39)
	(have_soil_analysis rover1 waypoint9)
	(have_soil_analysis rover2 waypoint2)
	(have_soil_analysis rover2 waypoint35)
	(have_soil_analysis rover5 waypoint21)
	(have_soil_analysis rover8 waypoint34)
	(have_soil_analysis rover8 waypoint4)
	(have_soil_analysis rover9 waypoint24)
	(have_soil_analysis rover9 waypoint6)
