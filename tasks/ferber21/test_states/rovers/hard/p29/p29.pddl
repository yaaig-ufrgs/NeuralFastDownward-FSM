...
(:init
	...
	(have_image rover1 objective5 colour)
	...
	(have_image rover4 objective7 high_res)
	...
	(have_image rover8 objective1 high_res)
	...
	(have_image rover8 objective5 colour)
	(have_image rover8 objective6 low_res)
	(have_image rover8 objective7 high_res)
	(have_image rover9 objective0 high_res)
	(have_rock_analysis rover7 waypoint19)
	(have_rock_analysis rover7 waypoint7)
	(have_soil_analysis rover2 waypoint9)
	(have_soil_analysis rover8 waypoint27)
	(have_soil_analysis rover8 waypoint6)
	(have_soil_analysis rover9 waypoint16)
	(have_soil_analysis rover9 waypoint23)
	(have_soil_analysis rover9 waypoint26)
