MODEL="15_ocls_ns_ubal_h3_sigmoid_inter_gen_sat_drp0_Kall_pruneOff_9_fold_model.pb"
DOMAIN="../../tasks/blocksworld_ipc/probBLOCKS-15-0/domain.pddl"
PROBLEM="../../tasks/blocksworld_ipc/probBLOCKS-15-0/p$1.pddl"
