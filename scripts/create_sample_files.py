...
Use: $ ./create_sample_files.py sas_plan  <init|random|entire>
e.g. $ ./create_sample_files.py ../sas_plan random
"""
...
if len(argv) != 3 or argv[2] not in ["init", "random", "entire"]:
    print("Use: ./create_sample_files.py sas_plan <init|random|entire>")
    exit()
