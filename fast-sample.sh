...
#
# Usage:
# $ ./fast-sample.sh [yaaig|ferber] [rw|dfs] [fs|ps|us|as] searches samples_per_search n_seeds problem_dir [cpu_id] output_dir
...
#
# Example:
# $ ./fast-sample.sh yaaig dfs fs 500 200 5 tasks/IPC/blocks samples
#
...
if [ $METHOD = "yaaig" ] || [ $METHOD = "ferber" ]; then
    STATE=$3
    SEARCHES=$4
            ...
            if [ $prob_name != "domain" ]; then
                for seed in $(seq 1 $N_SEEDS); do
                    ...
                    ./fast-downward.py \
                        ...
                        techniques=[gbackward_yaaig(searches=$SEARCHES, samples_per_search=$SAMPLES_PER_SEARCH, \
